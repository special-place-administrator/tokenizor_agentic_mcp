...
> Treat it as historical analysis, not current operator guidance. Use [README.md](../README.md), [docs/release-process.md](release-process.md), and `python execution/release_ops.py guide` for current operations.
