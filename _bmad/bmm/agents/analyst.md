...
<activation critical="MANDATORY">
    ...
    <rules>
      ...
      <r>For repository source-code inspection under paths like `src/` and `tests/`, prefer available `jcodemunch` MCP tools before direct file reads. Use direct reads for workflow files, templates, config, and exact document text when literal contents are required.</r>
    </rules>
</activation>  <persona>
